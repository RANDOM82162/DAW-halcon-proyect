    ...
    <div class="col-md-8">
        <div class="card mb-4">
            <div class="card-header bg-white fw-bold">
                <span><svg class="icon me-2"><use xlink:href="{{ asset('assets/icons/sprites/free.svg#cil-cart') }}"></use></svg> Crear Nuevo Pedido</span>
            </div>
            <div class="card-body">
                <form action="{{ route('orders.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('customer_number') is-invalid @enderror" id="customer_number" name="customer_number" value="{{ old('customer_number') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                            ...
                            <option value="ordered" {{ old('status') == 'ordered' ? 'selected' : '' }}>Ordenado</option>
                            <option value="in_process" {{ old('status') == 'in_process' ? 'selected' : '' }}>En proceso</option>
                            <option value="in_route" {{ old('status') == 'in_route' ? 'selected' : '' }}>En ruta</option>
